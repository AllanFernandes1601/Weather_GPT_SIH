...
export const ProfilePage: React.FC<ProfilePageProps> = ({
  ...
  const handleSimulateSevereWeather = () => {
    ...
    const message = `Heavy rainfall expected in ${locationName}. Avoid flood-prone underpasses.`;
    ...
    if (getBrowserNotificationPermission() === 'granted') {
      showWeatherNotification({
        title: 'WeatherGPT — HIGH Heavy Rain Alert',
        body: message,
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200 pb-12" id="profile-page-container">
      {/* HEADER BANNER */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-[#FFFDF9] via-[#FAF6EE] to-[#F5ECE0] border border-[#E5DCCF]/80 shadow-sm">
      ...
      <div className="space-y-3" id="profile-section-sms-delivery">
        <div className="px-2">
      ...
      <div
        className="rounded-3xl bg-[#FFFDF9] p-6 sm:p-8 shadow-sm border border-[#E5DCCF]/80 space-y-6"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-2xl bg-[#FAF8F5] border border-[#E5DCCF]/70 hover:border-[#D97706]/40 transition-colors">
            <div className="space-y-1 pr-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[14px] font-bold text-[#1C1814]">Browser Notifications</span>
              ...
              <p className="text-[12px] text-[#6E645A] leading-relaxed">
                Receive WeatherGPT alerts as desktop/browser notifications while the app is open.
              </p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-2xl bg-[#FAF8F5] border border-[#E5DCCF]/70 hover:border-[#D97706]/40 transition-colors">
            <div className="space-y-1 pr-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[14px] font-bold text-[#1C1814]">SMS Emergency Alerts</span>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-2xl bg-[#FAF8F5] border border-[#E5DCCF]/70 hover:border-[#D97706]/40 transition-colors">
            <div className="space-y-1 pr-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[14px] font-bold text-[#1C1814]">High Priority Alerts Only</span>
              </div>
              <p className="text-[12px] text-[#6E645A] leading-relaxed">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <p className="text-[13px] font-bold text-[#1C1814]">
                          {entry.severity.toUpperCase()} Heavy Rain
                        </p>
